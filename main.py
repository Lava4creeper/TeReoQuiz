...
def main_menu(maaori_list, english_list, main_menu_user_choice_input):
  ...
  while main_menu_user_choice_input != "exit":
    ...
    #If the user inputs the exit code
      ...
      time.sleep(0.75)
      #tell the user the exit code has been entered
...
#Defining the Vocabulary List
def vocabulary_list(main_menu_user_choice_input):
  #Defining the variables continue_with_list
  continue_with_list = ""
  #Looping the code and establishing an exit code
  while continue_with_list != 'exit':
    #Clearing the screen
    for item in range(0, 100):
      print()
    #Inform the user
    time.sleep(0.75)
    print("You have selected the list of vocab words. They will be displayed 10 at a time, press <enter> to continue or type 'exit' to exit")
    continue_with_list = input("►").lower()
    if continue_with_list == "exit":
      time.sleep(0.75)
    ...
    print()
    time.sleep(0.75)
    #Returning to mmain menu
    main_menu(maaori_list, english_list, main_menu_user_choice_input)
    
#Defining the quiz_start function    
def quiz_start(maaori_list, english_list):
  ...
  while input_rounds_to_play != "exit":
    ...
    #Getting the amount of games to play
    ...
    #If the user doesn't select infinite mode
      ...
      #Try making the variable input_rounds_to_play an integer
      try:
        ...
        #If the variable input_rounds_to_play isn't greater than 0
        else:
          #Clear the screen
          for item in range(1, 100):
            print()
...
#Defining the function infinite_quiz
def infinite_quiz():
  #Creating the variable quiz_input_answer
  quiz_input_answer = ""
  #Looping the code and setting up an exit code
  while quiz_input_answer != "exit":
    ...
    for item in range(1, 100):
      print()
    #Choosing a random number between 0 and 49 and assigning it to quiz_number_selector
    quiz_number_selector = random.randint(0, 49)
    #Choosing a random number between 0 and 1 and assigning it to type_of_quiz
    type_of_quiz = random.randint(0, 1)
    #If type_of_quiz is equal to 0, run a Maaori to English list
    if type_of_quiz == 0:
      time.sleep(0.75)
      #Ask the user what the english translation of the maaori word corresponding to the variable quiz_number_selector is
      ...
      if quiz_input_answer == "exit":
        ...
        #Return to main menu
        main_menu(maaori_list, english_list, main_menu_user_choice_input)
      #If the user enters the correct translation of the Maaori word corresponding to the variable quiz_number_selector
        ...
        if exit_or_continue == "exit":
          ...
          time.sleep(0.75)
          main_menu(maaori_list, english_list, main_menu_user_choice_input)
      #If the user entered the incorrect translation of the Maaori word corresponding to the variable quiz_number_selector
      else:
        time.sleep(0.75)
        ...
        if exit_or_continue == "exit":
          ...
          time.sleep(0.75)
          main_menu(maaori_list, english_list, main_menu_user_choice_input)
    #If the variable type_of_quiz is equal to 1 run an english to Maaori quiz
    elif type_of_quiz == 1:
      time.sleep(0.75)
      #Ask the user for the Maaori translation of the english word corresponding to the variable quiz_number_selector
      ...
      if quiz_input_answer == "exit":
        ...
        #Return to main menu
        main_menu(maaori_list, english_list, main_menu_user_choice_input)
      #If the user input the correct translation of the english word corresponding to the variable quiz_number_selector
      elif quiz_input_answer == maaori_list[quiz_number_selector]:
        #Tell the user they entered the correct translation of the english word corresponding to the variable quiz_number_selector
        ...
        if exit_or_continue == "exit":
          ...
          main_menu(maaori_list, english_list, main_menu_user_choice_input)
        time.sleep(0.75)
      #If the user input an incorrect translation of the Maaori word corresponding to the variable quiz_number_selector
      else:
  ...
  while quiz_input_rounds_to_play != "exit":
    ...
    for item in range(0, input_rounds_to_play):
      ...
      if type_of_quiz == 0:
        ...
        time.sleep(0.75)
        #Ask the user for the Maaaori translation of the english word corresponding to the variable quiz_number_selector
        print("What is the Maaori Translation of {}? ".format(english_list[quiz_number_selector]))
        quiz_input_answer = input("►").lower()
        print()
        #If the user enters the exit code
        if quiz_input_answer == 'exit':
          ...
          time.sleep(0.75)
          main_menu(maaori_list, english_list, main_menu_user_choice_input)
        #If the user enters the correct translation of the english word corresponding to the variable quiz_number_selector
